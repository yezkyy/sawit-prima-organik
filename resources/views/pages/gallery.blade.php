        ...
        <div class="container-custom">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" data-aos="fade-up">
                ...
                @empty
                    @php
                        $dummies = [
                            ['img' => 'https://images.unsplash.com/photo-1542601906970-d4d915a96833?auto=format&fit=crop&q=80&w=800', 'title' => 'Aplikasi Pupuk Hayati'],
                            ['img' => 'https://images.unsplash.com/photo-1516035054744-d474c5209db5?auto=format&fit=crop&q=80&w=800', 'title' => 'Panen TBS Melimpah'],
                            ['img' => 'https://images.unsplash.com/photo-1592419044706-39796d40f98c?auto=format&fit=crop&q=80&w=800', 'title' => 'Cek Kesehatan Akar'],
                            ['img' => 'https://images.unsplash.com/photo-1596733430284-f7437764b1a9?auto=format&fit=crop&q=80&w=800', 'title' => 'Kebun Sawit Mitra'],
                            ['img' => 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&q=80&w=800', 'title' => 'Edukasi Petani'],
                            ['img' => 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?auto=format&fit=crop&q=80&w=800', 'title' => 'Distribusi Produk'],
                        ];
                    @endphp
                    @foreach($dummies as $d)
                        <div class="group relative overflow-hidden rounded-[2.5rem] bg-white p-4 shadow-soft border border-gray-100 hover:border-primary/20 transition-all duration-500">
                            <div class="relative overflow-hidden rounded-[1.8rem] aspect-square">
                                <img src="{{ $d['img'] }}" alt="{{ $d['title'] }}" class="w-full h-full object-cover transition duration-1000 group-hover:scale-110">
                                <div class="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-8">
